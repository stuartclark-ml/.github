...
| :--- | :--- | :--- | :--- |
| **[RAG Triage API](https://github.com/stuartclark-ml/rag-triage-api)** | Agentic FastAPI service for H&C care home incident triage. Sequential four-tool pipeline combining a fine-tuned BERT classifier with RAG over RIDDOR 2013, HSG220, and OSHA H&C data. Deployed across AWS ECS Fargate and Vercel. | FastAPI, ChromaDB, HuggingFace, Gemini 2.5 Flash, AWS (ECS, S3, Secrets Manager), Vercel | ✅ [Live](https://rag-triage.vercel.app) |
| **[Regulatory Document Intelligence Pipeline](https://github.com/stuartclark-ml/ohs-document-parser)** | End-to-end extraction API for unstructured compliance records (PDF/JPG). Automates parsing of complex certificates. | FastAPI, Gemini 2.5 Flash, PyMuPDF, Pydantic v2 | ✅ [Live](https://comfortable-achievement-production.up.railway.app/) |
